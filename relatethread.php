...
/*
	...
	$Id: relatethread.php 10137 2007-08-24 03:50:58Z liuqiang $
*/
...
$data = @implode('', file("http://related.code.qihoo.com/related.html?title=$subjectenc&ics=$charset&ocs=$charset&site=$site&sort=pdate&tshow=$tshow&intnum=$intnum&extnum=$extnum&exttype=$exttype"));
...
if($data) {
	...
	$expiration = $svalid > $qihoo['relate']['validity'] * 86400 ? $timestamp + $svalid : $timestamp + $qihoo['relate']['validity'] * 86400;
