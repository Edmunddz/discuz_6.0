...
/*
	...
	$Id: insenz.inc.php 10364 2007-08-27 07:58:07Z liuqiang $
*/
...
<?php
	...
	if(submitcheck('acceptsubmit')) {
		...
		$db->query("INSERT INTO {$tablepre}forums(fup, type, name, status, displayorder) VALUES ('$insenz[gid]', 'forum', '$c_forumname', '0', '-1')");
		$fid = $db->insert_id();
