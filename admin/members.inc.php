...
/*
	...
	$Id: members.inc.php 10115 2007-08-24 00:58:08Z cnteacher $
*/
				...
				if(empty($includepost)) {
					...
					if($threads) {
						foreach($threads as $fid=>$tids) {
							...
							foreach(array('threads', 'threadsmod', 'relatedthreads', 'posts', 'polls', 'polloptions', 'trades', 'activities', 'activityapplies', 'debates', 'debateposts', 'attachments', 'favorites', 'mythreads', 'myposts', 'subscriptions', 'typeoptionvars') as $value) {
