...
/*
	...
	$Id: magic_del.inc.php 9806 2007-08-15 06:04:37Z cnteacher $
*/
...
if(submitcheck('usesubmit')) {
	...
	if($post['first']) {
		foreach(array('threads', 'threadsmod', 'relatedthreads', 'posts', 'polls', 'polloptions', 'trades', 'activities', 'activityapplies', 'attachments', 'favorites', 'mythreads', 'myposts', 'subscriptions', 'debates', 'debateposts', 'typeoptionvars') as $value) {
