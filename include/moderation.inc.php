...
/*
	...
	$Id: moderation.inc.php 10329 2007-08-27 00:58:57Z heyond $
*/
...
if(!submitcheck('modsubmit')) {
	...
	if($operation == 'delete') {
		...
		if($forum['recyclebin']) {
			...
			foreach(array('threads', 'threadsmod', 'relatedthreads', 'posts', 'polls', 'polloptions', 'trades', 'activities', 'activityapplies', 'debates', 'videos', 'debateposts', 'attachments', 'favorites', 'mythreads', 'myposts', 'subscriptions', 'typeoptionvars') as $value) {
